 ...
 *
 * Endpoint:  GET /api/listColors?page=2&size=10&locale=pt-BR
 * Response:  { "page": 2, "size": 10, "locale": "pt-BR", "result": { "items": [...], "pageNumber": 2, "pageCount": ..., "totalItems": ... } }
 */
const { listColors } = require('../lib/with-ptbr.js');
...
module.exports = function handler(req, res) {
    ...
    const result = listColors(page, size, locale);
    sendJson(res, 200, { page: page, size: size, locale: locale, result: result });
};